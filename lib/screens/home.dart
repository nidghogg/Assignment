...
import 'package:flutter_demo/screens/moreGames.dart';
  ...
  void didChangeDependencies() {
    ...
    setState(() {
      timer = Timer.periodic(
          const Duration(milliseconds: 1500), (Timer t) => jackpotPrize++);
    });
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        ...
        children: <Widget>[
          CarouselSlider(
            items: carouselImagesList.map((element) {
              return Image(
          ...
          Row(
            ...
            children: carouselImagesList.asMap().entries.map((entry) {
          ...
          Container(
            decoration: const BoxDecoration(
                color: Color.fromRGBO(122, 36, 176, 1),
                border: Border(
                    top: BorderSide(
                    ...
                    bottom: BorderSide(
                        ...
                        width: 5))),
            height: 80,
            // color: const Color.fromRGBO(122, 36, 176, 1),
            child: Padding(
          ...
          const Center(
            child: Padding(
              ...
              child: Text('LIVE WITHDRAWAL',style: TextStyle(
                  color: Colors.orange,fontWeight: FontWeight.w700,fontSize: 30
              ),
              )
            ),
          ),
                  ...
                  GridView.builder(
                    shrinkWrap: true,
                      gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                          mainAxisSpacing: 2, crossAxisCount: 2,childAspectRatio: 4
                      ),
                    itemCount: 4,
                    itemBuilder: (BuildContext context, int index) {
                        return _userCard(names[index]);
                    },
                  )
                ],
              ),
          ...
          Row(
            ...
            children: [
              const Padding(
                ...
                child: Text('Games plane',style: TextStyle(color: Colors.white, fontSize: 20),),
              ),
              TextButton(onPressed: () {
                Navigator.of(context)
                    .push(MaterialPageRoute(builder: (context) => const MoreGames())
                );
